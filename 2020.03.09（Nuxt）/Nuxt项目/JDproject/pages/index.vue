    ...
    <div class="head">
      <div class="container">
        <div class="row gutter">
          ...
          <div class="col-8">
            ...
            <ul class="head-menus">
              <li v-for="(item,index) in 9" :key="index">
                <nuxt-link to>秒杀{{item}}</nuxt-link>
              </li>
            </ul>
          </div>
          <!-- 广告图片 -->
          <div class="col-2">
            <img
              src="https://img11.360buyimg.com/babel/jfs/t1/96938/31/14556/30834/5e684786Ee4086355/ec2eb6c52115485f.png.webp"
              alt
            />
          </div>
        </div>

      ...
      <div class="fillin_bd">
        ...
        <div class="address">
          ...
          <div class="address_select none">
            <ul>
              <li class="cur">
                <input type="radio" name="address" checked="checked" />小明 北京市 昌平区 建材城西路金燕龙办公楼一层 13555555555
                <a href>设为默认地址</a>
                <a href>编辑</a>
                <a href>删除</a>
              </li>
              <li>
                <input type="radio" name="address" />小明 湖北省 武汉市 武昌 关山光谷软件园1号201 13333333333
                <a href>设为默认地址</a>
                <a href>编辑</a>
                <a href>删除</a>
              </li>
              <li>
                <input type="radio" name="address" class="new_address" />使用新地址
              </li>
            </ul>
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td class="col1">
                  <a href>
                    <img src="/jdshop/images/cart_goods1.jpg" alt />
                  </a>
                  <strong>
              ...
              <tr>
                <td class="col1">
                  <a href>
                    <img src="/jdshop/images/cart_goods2.jpg" alt />
                  </a>
                  <strong>
...
export default {
  ...
  head() {
    return {
      link: [{ rel: "stylesheet", href: "/jdshop/style/fillin.css" }],
      script: [
        { src: "/jdshop/js/jquery-1.8.3.min.js" },
        { src: "/jdshop/js/cart2.js" }
      ]
    };
  }
};
